      ...
      <AnimatePresence mode="wait">
        {isLoginPage ? (
          ...
          >
            <div className="w-full lg:w-1/2 flex items-center justify-center p-4 lg:p-12">
              <div className="w-full max-w-md">
                <h1 className="text-3xl lg:text-4xl font-bold mb-6">Sign In</h1>
                <div className="space-y-4 mb-4">
                  <button className="w-full flex items-center justify-center space-x-2 border border-gray-300 rounded-lg px-4 py-2 text-sm lg:text-base text-white hover:bg-gray-700 transition duration-150">
                  ...
                  <button className="w-full flex items-center justify-center space-x-2 border border-gray-300 rounded-lg px-4 py-2 text-sm lg:text-base text-white hover:bg-gray-700 transition duration-150">
                    <svg viewBox="0 0 24 24" width="24" height="24" xmlns="http://www.w3.org/2000/svg">
                      <path d="M12.152 6.896c-.948 0-2.415-1.078-3.96-1.04-2.04.027-3.91 1.183-4.961 3.014-2.117 3.675-.546 9.103 1.519 12.09 1.013 1.454 2.208 3.09 3.792 3.039 1.52-.065 2.09-.987 3.935-.987 1.831 0 2.35.987 3.96.948 1.637-.026 2.676-1.48 3.676-2.948 1.156-1.688 1.636-3.325 1.662-3.415-.039-.013-3.182-1.221-3.22-4.857-.026-3.04 2.48-4.494 2.597-4.559-1.429-2.09-3.623-2.324-4.39-2.376-2-.156-3.675 1.09-4.61 1.09zM15.53 3.83c.843-1.012 1.4-2.427 1.245-3.83-1.207.052-2.662.805-3.532 1.818-.78.896-1.454 2.338-1.273 3.714 1.338.104 2.715-.688 3.559-1.701" fill="#FFFFFF"/>
                    </svg>
          ...
          >
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-4 lg:p-12">
              <div className="w-full max-w-md">
                <h1 className="text-3xl lg:text-4xl font-bold mb-6">Sign Up</h1>
                <div className="space-y-4 mb-4">
                  <button className="w-full flex items-center justify-center space-x-2 border border-gray-300 rounded-lg px-4 py-2 text-sm lg:text-base text-white hover:bg-gray-700 transition duration-150">
                    <svg viewBox="0 0 24 24" width="24" height="24" xmlns="http://www.w3.org/2000/svg">
                      <g transform="matrix(1, 0, 0, 1, 27.009001, -39.238998)">
                ...
                <form className="space-y-4">
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 bg-gray-800 rounded-md text-sm lg:text-base focus:outline-none focus:ring-2 focus:ring-purple-600"
                  />
                  <button className="w-full bg-white text-black py-2 rounded-md text-sm lg:text-base hover:bg-gray-200 transition duration-150">Sign Up</button>
                </form>
              </div>
            </div>
          </motion.div>
